...
interface CategorizarDocumentosParams {
  parametro: string;
  filtro?: string;
}

async function categorizarDocumentos(params: CategorizarDocumentosParams): Promise<void> {
  try {
    ...
    console.log(`Executando categorizarDocumentos com parametro=${params.parametro}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Categoriza documentos do processo concluído com sucesso",
      resultado: {
...
export default categorizarDocumentos;
