...
interface IndexarProcessoParams {
  numeroProcesso: string;
  tribunal?: string;
}

async function indexarProcesso(params: IndexarProcessoParams): Promise<void> {
  try {
    ...
    console.log(`Executando indexarProcesso com numeroProcesso=${params.numeroProcesso}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Organiza documentos e metadados de processo concluído com sucesso",
      resultado: {
...
export default indexarProcesso;
